...
class IngestorInterface(ABC):
    """Abstract class for ingestors. Offers a common interface for all types of quote sources."""
    allowed_extensions = []
    
    @classmethod
    def can_ingest(cls, path: str) -> bool:
        """Checks if this ingestor can ingest a file
    ...
    def parse(cls, path: str) -> List[QuoteModel]:
        """Parses a quote source file to a list of quotes
